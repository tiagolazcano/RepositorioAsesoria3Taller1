...
ts_pais_pandemia <- ts(base_menores_pandemia$Casos, start = c(2017, 1), frequency = 52)
...
# Crear objetos TS para graficar
...
# Nota: xlim ahora usa años (2017 a 2026) gracias al ts() del inicio
plot(ts_pais_pandemia, xlim = c(2017, 2026), ylim = c(0, 45000), 
     main = "Proyección Total Menores de 5 Años (Próximas 52 Semanas)", 
